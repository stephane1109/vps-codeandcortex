...
- APP_TICKET_MAX_ACTIVE
  ...
  Cette application PDF peut monter a 5 utilisateurs simultanes :
  APP_TICKET_MAX_ACTIVE=5
...
- laisse APP_TICKET_MAX_ACTIVE=5 pour ce service PDF leger
...
def _config(default_app_id: str, app_label: str) -> dict[str, Any]:
    return {
        ...
        "app_label": app_label,
        "max_active": max(1, _env_int("APP_TICKET_MAX_ACTIVE", 5)),
