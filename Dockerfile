...
# #### VARIABLES D'ENVIRONNEMENT A PERSONNALISER DANS COOLIFY
...
# - APP_TICKET_WAIT_STALE_SECONDS=120 pour nettoyer plus vite la file d'attente si un onglet est abandonne
