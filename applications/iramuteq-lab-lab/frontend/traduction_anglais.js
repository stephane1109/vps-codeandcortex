...
const ENGLISH_TRANSLATIONS = Object.freeze({
  ...
  "Allemand - dico IRaMuTeQ (mots-outils)": "German - IRaMuTeQ dictionary (function words)",
  ...
  "Le dictionnaire allemand fourni contient actuellement des mots-outils (sw) uniquement ; il ne catégorise pas encore les noms et les verbes.": "The German dictionary currently contains function words (sw) only; it does not yet categorize nouns and verbs.",
  "Modèle linguistique spaCy installé sur le serveur": "spaCy language model installed on the server",
  "Exemple : de_core_news_md": "Example: de_core_news_md",
  "Allemand": "German",
  "Néerlandais": "Dutch",
  "Portugais": "Portuguese",
  "Catalan": "Catalan",
  "Grec": "Greek",
  "Utilisez de préférence un modèle": "Prefer a",
  ", ou": ", or",
  "pour réduire le temps de calcul. Les modèles multilingues": "to reduce computation time. spaCy multilingual",
