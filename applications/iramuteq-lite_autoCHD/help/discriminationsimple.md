...
Dans le résultat de la configuration retenue, l'application affiche jusqu'à cinq mots repères par classe. Ce sont des termes caractéristiques significatifs (`p.value <= 0.05`) présents sur l'AFC finale.
