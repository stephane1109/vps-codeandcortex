...
exporter_chd_statique <- function(res, dfm_obj, groupes, classes_df, export_dir, file_stem, rv = NULL) {
  ...
  writeLines(
    c(
      ...
      "  <style>",
      "    body{margin:0;padding:32px;font-family:Arial,Helvetica,sans-serif;color:#263A63;background:#F5F7FB;font-size:15px;line-height:1.45;}",
      "    main{max-width:1440px;margin:0 auto;}",
      "    h1{font-size:28px;margin:0 0 10px;font-weight:700;}",
      "    h2{font-size:20px;margin:28px 0 10px;font-weight:700;}",
      "    .meta{margin:0 0 24px;color:#68728A;}",
      "    figure{margin:0;}",
      "    img{display:block;width:100%;height:auto;border:1px solid #D8DDEC;}",
      "    table{width:100%;border-collapse:collapse;margin-top:8px;font-size:14px;}",
      "    th,td{border:1px solid #D8DDEC;padding:8px 10px;text-align:left;vertical-align:top;background:#FFFDF8;}",
      "    th{background:#E9EDF7;font-weight:700;}",
      "  </style>",
      "</head>",
      "<body>",
      "  <main>",
